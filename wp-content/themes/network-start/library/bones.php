...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			'main-nav' => __( 'The Main Menu', 'glocal-network' ),   // main nav in header
			...
			'footer-links' => __( 'Footer Links', 'glocal-network' ) // secondary nav in footer
		)
	);
...
function bones_main_nav() {
	...
	wp_nav_menu(array(
		...
		'menu' => __( 'The Main Menu', 'glocal-network' ),  // nav name
...
function bones_footer_links() {
	...
	wp_nav_menu(array(
		...
		'menu' => __( 'Footer Links', 'glocal-network' ),   // nav name
...
function bones_related_posts() {
	...
	if($tags) {
		...
		if($related_posts) {
			...
			<?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', 'glocal-network' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_query();
	echo '</ul>';
...
function bones_excerpt_more($more) {
	...
	return '...  <a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'glocal-network' ) . get_the_title($post->ID).'">'. __( 'Read more &raquo;', 'glocal-network' ) .'</a>';
}
