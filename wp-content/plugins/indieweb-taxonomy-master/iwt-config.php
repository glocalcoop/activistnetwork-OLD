...
function add_iwt_options_to_menu(){
	add_options_page( '', 'Indieweb Taxonomy', 'manage_options', 'iwt_options', 'iwt_options_form');
}
...
function iwt_options_init() {
    ...
    add_settings_field( 'multikind', 'Allow Ability to Select Multiple Kinds for a Single Post', 'iwt_callback', 'iwt_options', 'iwt-content' ,  array( 'name' => 'multikind') );
...
function iwt_options_form()
  {
    ?>
     <div class="wrap">
        <h2>Indieweb Taxonomy</h2>
        <p>Adds a semantic layer to posts to allow them to be responses to other content</p>
