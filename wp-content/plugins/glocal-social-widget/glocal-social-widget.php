...
Description: A plugin that enables you to add your social links to your site.
Version: 1.0
Author: Pea
Author URI: http://glocal.coop
License: GPL3
Text Domain: glocal-social-widget
*/
...
class glocal_social_plugin extends WP_Widget {
	...
	function glocal_social_plugin() {
		parent::WP_Widget(false, $name = __('Social Links Widget', 'glocal-social-widget') );
	}
	...
	<label for="<?php echo $this->get_field_id('github'); ?>"><?php _e('Github:', 'glocal-social-widget'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('github'); ?>" name="<?php echo $this->get_field_name('github'); ?>" placeholder="https://github.com/GITHUBRNAME" type="text" value="<?php echo $github; ?>" />
	</p>
